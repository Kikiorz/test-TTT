...
from .smolvla_ttt.configuration_smolvla_ttt import SmolVLATTTConfig
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from .pi0_ttt.modeling_pi0_ttt import PI0TTTPolicy
    ...
    elif name == "smolvla_ttt":
        from .smolvla_ttt.modeling_smolvla_ttt import SmolVLATTTPolicy

        return SmolVLATTTPolicy
    elif name == "groot":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "smolvla_ttt":
        return SmolVLATTTConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, SmolVLATTTConfig):
        from .smolvla_ttt.processor_smolvla_ttt import make_smolvla_ttt_pre_post_processors

        processors = make_smolvla_ttt_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
